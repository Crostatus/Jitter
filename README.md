...
If you insert a non valid name with the option **-i**, the programm will show you the devices list

**Otherwise**, if you need help, you can run it with "**-h**" to read a short description on how to launch and what to expect from it.

**Examples**:    
- `sudo ./jitter 50` &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; will stop after capturing the next 50 packets.    
- `sudo ./jitter`&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp; will start sniffing until interrupted.    
- `sudo ./jitter -i device_name`&emsp;&nbsp;&nbsp;&nbsp; will start sniffing from the device_name interface (if is a valid device) until interrupted.
- `sudo ./jitter 50 -i device_name` &nbsp; will stop after capturing the next 50 packets from the device_name interface.  
- `sudo ./jitter -h` &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp; will show a help description.
